...
<tp:base>
    <jsp:attribute name="body">
        <div id="js-search-questoes">
            <div>
                <label for="js-disciplinas"></label>
                <select name="js-disciplinas" id="js-disciplinas" v-model="disciplinaSelecionada">
                    <option selected="selected" >Selecione uma matéria</option>
                    <option v-for="disciplina in disciplinas" :key="disciplina.id">{{disciplina.nome}}</option>
                </select>
            </div>

            <div id="js-seleciona-materia">
                <div class="js-materias-selecionadas">
                    <div class="materia-selecionada" v-for="materia in materiasSelecionadas"></div>
                </div>
            </div>

            <div id="js-tabela-questoes">
                <div class="row">
    ...
    const store = new Vuex.Store({
        state: {
            ...
            columns: [
                ...
                { label: 'Username', field: 'user.username', filterable: true },
